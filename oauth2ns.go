...
func getAuthFromKeyring() (token oauth2.Token) {
	...
	tokenJSON, _ := ring.Get("token")
	tokenInter := oauth2.Token{}
	json.Unmarshal(tokenJSON.Data, &tokenInter)
